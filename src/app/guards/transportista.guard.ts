...
export class TransportistaGuard implements CanActivate {
  ...
  public canActivate(
    ...
    if(this.authService.isLoggedIn && this.authService.esTransportista()) {
      return true;
    }
    else
    {
      //Mensaje, debe estar logueado y debe tener permisos de administrador
      this.alertService.error("Se requieren permisos de Transportista para entrar a ésta página.")
      return false;
    }
