import { PlanificacionCabeceraLazy } from './planificacion_cabecera_lazy';

export class PlanificacionCabeceraLazyGrilla {
    cabecera:       PlanificacionCabeceraLazy;
    id:             number;
    numero:         string;
    fechaCarga:     Date;
    ...
    constructor(viaje: PlanificacionCabeceraLazy) {
        this.cabecera    = viaje;
